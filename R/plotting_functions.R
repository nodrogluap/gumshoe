...
#' @param q_max The maximum q-value that should be used as a cutoff to determine significant transcripts. Defaults to .05.
...
heatmap_plot <- function(sleuth_obj, genes, q_max = .05, test = "wt", sig_marker_values = c(.05, .01, .001), sig_markers = c("*", "**", "***"), 
                        grouping_colours = list(), boxplot = TRUE){
  ...
  # Merge the transcript q-values and all 
